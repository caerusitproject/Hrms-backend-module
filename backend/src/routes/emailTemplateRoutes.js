...
router.get('/types',authenticate, authorizeRoles("ADMIN","HR"), emailTemplateController.getTemplateByType);
router.get('/alltypes', authenticate, authorizeRoles("ADMIN","HR"), emailTemplateController.getAllTemplateTypes); 
